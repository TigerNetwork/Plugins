...
if Config.BOT_USERNAME is not None and tgbot is not None:
    ...
    async def inline_handler(event):
        ...
        if event.query.user_id in auth and query == "hellbot_help":
            ...
            result = builder.article(
                title="Repository",
                text=f"**⚡ʟᴇɢᴇɴᴅᴀʀʏ ᴀғ TɪɢᴇʀUsᴇʀBᴏᴛ⚡️**",
                buttons=[
                    [Button.url("📑 ʀᴇᴘᴏ 📑", "https://github.com/TigerNetwork/TigerUserBOT")],
                    [Button.url("TɪɢᴇʀUsᴇʀBᴏᴛ", "https://t.me/TigerNetwork")],
                ],
            )
            ...
            result = builder.article(
                "@TigerNetwork",
                text="""**Hey! This is [WarUserBot](https://t.me/TigerNetwork) \nYou can know more about me from the links given below 👇**""",
                buttons=[
                    [
                        custom.Button.url("🔥 ᴄʜᴀɴɴᴇʟ 🔥", "https://t.me/TigerNetwork"),
                        custom.Button.url("⚡ ɢʀᴏᴜᴘ ⚡", "https://t.me/TigerNetworksupport"),
                    ],
                    [
                        custom.Button.url("✨ ʀᴇᴘᴏ ✨", "https://github.com/TigerNetwork/TigerUserBOT"),
                        custom.Button.url("🔰 ᴛᴜᴛᴏʀɪᴀʟ 🔰", "https://t.me/TigerNetwork"),
                    ],
                ],
                link_preview=False,
            )
