...
async def _(event):
    ...
    await hell.delete()
    os.system("rm /root/warbot/WARBOT.jpg ")
...
async def gbun(event):
    ...
    if event.reply_to_msg_id:
        ...
        if idd == 1891078417:
            await hell.edit("`Wait a second, This is my master!`\n**How dare you threaten to ban my master nigger!**\n\n__Your account has been hacked! Pay 69$ to my master__ [TheFather](https://t.me/thefather69) __to release your account__😏", link_preview=False)
        else:
            jnl = (
                "`Warning!! `"
                "[{}](tg://user?id={})"
